...
var fontsSourcePath, fontsTargetPath;
...
for (var x = 0; x < platforms.length; x++) {
    try {
        ...
        fontsSourcePath = path.join(basePath, 'dist', 'fonts');
        fontsTargetPath = path.join(basePath, 'fonts');
        ...
        move(fontsSourcePath, fontsTargetPath, true);
